...
import * as AppFunction from '../../services/appFunctions';
        ...
        return (
            <div className="container-fluid issueBox">
                <div className="container">
                    ...
                    <div className="row">
                        <Button className="buttonColor waves-effect waves-light deep-purple darken-1" onClick={AppFunction.goBack}>Back</Button>
                    </div>
                </div>
            </div>
        );
